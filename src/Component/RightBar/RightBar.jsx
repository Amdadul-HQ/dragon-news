    ...
    return (
        <div>
            ...
            <div className="text-base font-medium text-Dark2">
                <Link className="flex w-full py-4 items-center border rounded-t-lg pl-4 border-Dark3"><FaFacebookF className="border text-3xl text-Btnbg rounded-full mr-3 p-2"/> Facebook</Link>
                <Link className="flex w-full py-4 items-center border-x pl-4 border-Dark3"><FaTwitter className="border text-3xl text-Btnbg rounded-full mr-3 p-2"/>Twitter</Link>
                <Link className="flex w-full py-4 items-center border rounded-b-lg pl-4 border-Dark3"><FaInstagram className="border text-3xl text-Btnbg rounded-full mr-3 p-2"/>Instagram</Link>
            </div>
